...
export default function ThemeToggle() {
    ...
    useEffect(() => {
        ...
        const colorTheme = localStorage ? localStorage.getItem('color-theme') : 'light';
    ...
    return (
        <button
            id="theme-toggle"
            type="button"
            className="text-gray-500 dark:text-gray-400 hover-hover:bg-gray-100 dark:hover-hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-3"
            onClick={toggleTheme}
        >
            <svg
