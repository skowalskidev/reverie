...
const ToolLink = ({ title, imgSrc, alt, toolLinkHref, label }: Props) => {
    return (
        <Link className='outline outline-black text-black hover:!text-purple-600 hover:!outline-purple-600 dark:outline-white dark:text-white p-3 rounded flex flex-col justify-between gap-4 relative' href={toolLinkHref} >
